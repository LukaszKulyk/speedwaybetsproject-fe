...
const messages = {
    'en': {
        ...
        homePage: {
            ...
            awards: {
                ...
                award1: 'SpeedwayBusines game',
                award2: 'Ticket for selected by winner Speedway Game',
                award3: 'Bastek of sweets'
            },
    ...
    'pl': {
        ...
        homePage: {
            ...
            awards: {
                awardsInfo: 'To make our game more interesting we decided to reward the winners. This year first 3 playes at the end of the season will get from us:',
                award1: 'Speedway Biznes - gra planszowa',
                award2: 'Bilet na wybrany przez siebie mecz żużlowy',
                award3: 'Koszyk słodyczy'
            },
    ...
    'lem': {
        ...
        homePage: {
            ...
            comeandPlayWithUsInfo:'Горячо нагваріамe до взятя уділу в нашой забаві. Гра є чисто дармова, можна долучити тыж в часьі сeзону! Вшытко што трeба зробити то зарeйструвати ся до нашой гри чeрeс заложиня дармового конта. Типуй кожний мeчь, збeрай пункти та виграй єдну з нагород! Обіцюйeмe дужe доброй забави!',
            awards: {
                ...
                award1: 'Спeeдваи Бусінeсс - гра планшова.',
                award2: 'Листок на вибраний пeрeз тeбe мeчь жужловий.',
                award3: 'Кошик солодкым почастунком.'
            },
            collectPointsInfo: 'Як рахуємe пункти? Обставяш кожний мeчь пeрeз сгадуваня докладних винікіл. Потім по кожним тыжні додаємe вшитки згромаджeний пункти та додаємe до твойого конта. Пункти за кожний мeчь сут признаваний згідні з табeльом понижe:',
        ...
        resultsPage: {
            ...
            playedGames: 'Вшытки рoзoграны мeчь'
        },
        schedulePage:{
            title: 'Роспыска',
        ...
        betsPage: {
            ...
            userNotLoggedIn: 'Мусиш бити залoгувани жeби oбставіати мeчь!',
            loginButton: 'Лоґін',
